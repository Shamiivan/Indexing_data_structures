...
import a1.ADTList;
import a1.DoubleLinkedList;
import a1.SingleLinkedList;
...
public class ADTListTest {
    ...
    public void testFind()
    {
        ...
        assertTrue(find(L1, 3));
        assertFalse(find(L1, 29));
        assertTrue(find(L1, 5));
    }
